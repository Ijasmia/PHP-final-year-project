...
if(isset($_POST)) {
	...
	if($password != $con_password)
  {
	...
	if($result->num_rows == 0) {
		...
		$sql = "INSERT INTO users(firstname, lastname, email, password, hash, phone, whatsapp) VALUES ('$firstname', '$lastname', '$email', '$password', '$hash', '$phone', '$whatsapp')";
		...
		if($link->query($sql)===TRUE) {
			...
			<a href="adsgray.com/job1/verify.php?token='.$hash.'&email='.$email.'">Verify Email</a>
		 </body>
			</html>
		 ';
